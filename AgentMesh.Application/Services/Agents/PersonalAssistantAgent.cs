            ...
            agentInputSerializer)
    {
        ...
        protected override UserRequestResult ParseStructuredResponse(string rawResponseText)
        {
            try
            {
                ...
                // per decommentare dovremmo far arrivare in questa funzione il parametro di input RequestFailed, e poi fare un check su quello, ma non � chiaro se sia il caso di farlo qui o in un altro punto del flusso
